...
/**
 * Detect provider from request URL/path
 * Returns '2c2p', 'omise', or null
 */
function detectProvider(request) {
  ...
  if (pathname.startsWith('/api/payment') || url.startsWith('/api/payment')) {
    return '2c2p';
  }
 ...
 */
export async function checkForceError(request) {
